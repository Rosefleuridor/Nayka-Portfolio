...
export function Timeline() {
  return (
    <div
      className="space-y-12 relative md:before:absolute md:before:inset-0 md:before:left-1/2 md:before:ml-0 md:before:-translate-x-px md:before:border-l-2 md:before:border-zinc-700 md:before:h-full md:before:z-0"
    >
      {experiences.map((experience, index) => (
        ...
        >
          ...
          <div className="absolute left-1/2 -translate-x-1/2 items-center justify-center hidden md:flex">
            <div className="w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 z-10 flex items-center justify-center">
